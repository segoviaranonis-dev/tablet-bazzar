...
| **2.3.1.7.5.3.17** | **CSV precios Tito · tab FI** | `csv-precios` | [CHUSAR_CSV_PRECIOS_TITO](./CHUSAR_CSV_PRECIOS_TITO_PP_20260811.md) | 🟢 **PROD** · `c85cef3` · Precio Unitario post-D4 · [DEPLOY](./CHUSAR_DEPLOY_CSV_PRECIOS_TITO_20260811.md) |
| **2.3.1.7.5.3.18** | **Emparejamiento vendedor PP · FI↔IC** | tab FI · CSV · Logística | [CHUSAR_EMPAREJAMIENTO_VENDEDORES](./CHUSAR_EMPAREJAMIENTO_VENDEDORES_PP_20260811.md) | 🟢 **2026-08-11** · `dfd1e31` · error **4.02.03.026** · [DEPLOY](./CHUSAR_DEPLOY_EMPAREJAMIENTO_VENDEDOR_PP_20260811.md) |
