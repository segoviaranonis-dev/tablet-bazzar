...
| LR 638 estilo col J + thumb línea | **2.3.5.10** | local · Documenta 2026-08-17 |
...
| Tema | Código | Estado |
|------|--------|--------|
| **Pilar color · TONO** | **2.3.5.3** / **2.3.5.5.2** | 🟡 ley canon |
| **Diccionarios traductores** | **2.3.5.6** | 🟢 local |
| **CHINELO deuda arq** | **2.3.5.7** | 🟢 operativa local · marca→Beira · caso CHI **2.2.1.56** |
| **Mapa SDRM 654 L+R** | **2.3.5.8** | 🟢 audit+apply |
| **AB-CR ACT PRENDAS + OTROS** | **2.3.5.9** | 🟢 ejecutado · soft refresh PE |
| **LR 638 estilo col J + thumb línea** | **2.3.5.10** | 🟢 local · Documenta 2026-08-17 |
...
| Tema | Código | Estado |
|------|--------|--------|
| **Recovery 2FA + billing Supabase** | **4.90.01.002** | 🔴 Andrés confirmar sesión · pago · dump |
| Veredicto examen aislado | **5.01.00.032** | ⏳ zip recibido · APROBADO CON OBS RLS |
| Entorno aislado prod `-x` | **rimec-nexus** | Andrés · no mezclar OPS legacy |
